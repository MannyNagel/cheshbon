...
const articleSections = [
  {
    ...
    paragraphs: [
      'Daily Cheshbon is a personal reflection app designed to help you review your day with honesty, structure, and purpose.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Daily Cheshbon helps you make that process simple, consistent, and personal.',
    ],
  },
  {
    ...
    paragraphs: [
      ...
      'Daily Cheshbon is built around that reality.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Daily Cheshbon helps you see more than isolated moments. It helps you understand your growth over time.',
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.hero}>
        ...
        <Text style={styles.title}>Welcome to Daily Cheshbon</Text>
        <Text style={styles.subtitle}>A nightly cheshbon hanefesh for intentional growth.</Text>
      </View>
